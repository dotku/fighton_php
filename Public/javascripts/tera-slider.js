    ...
    $slider.mousemove(function(e){ // Get the cursor position
        ...
        if($sldr.hasClass('multi-slides')){
            ...
            if($mousePos.x > $(window).width()/2) {
                $sldr.css('cursor', 'url(/Public/images/tera-slider/slide-right-dark.png), e-resize');
                if($('body').hasClass('dark-slide'))
                    $sldr.css('cursor', 'url(/Public/images/tera-slider/slide-right.png), e-resize');
            } else {
               $sldr.css('cursor', 'url(/Public/images/tera-slider/slide-left-dark.png), w-resize');
                if($('body').hasClass('dark-slide'))
                    $sldr.css('cursor', 'url(/Public/images/tera-slider/slide-left.png), w-resize');
            }
        }
    });
